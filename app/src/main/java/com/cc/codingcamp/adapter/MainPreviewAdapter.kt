...
class MainPreviewAdapter(private val mainPreviews: List<MainPreview>) : RecyclerView.Adapter<MainPreviewAdapter.ViewHolder>() {
    private var expandedPosition: Int = RecyclerView.NO_POSITION

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_parentpreview, parent, false)
